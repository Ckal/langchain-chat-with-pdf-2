...
with gr.Blocks(css=css) as demo:
    with gr.Column(elem_id="col-container"):
        ...
        with gr.Column():
            ...
            repo_id = gr.Dropdown(label="LLM", choices=["mistralai/Mistral-7B-Instruct-v0.1", "google/flan-ul2", "OpenAssistant/oasst-sft-1-pythia-12b", "bigscience/bloomz"], value="google/flan-ul2")
            with gr.Row():
